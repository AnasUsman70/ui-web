  ...
  return (
    <div className='bg-zinc-900  py-5 text-white  px-5  w-full'>
      <div className='flex flex-col md:flex-row justify-around gap-10 '>
        <div>
          ...
          <div className='text-sm flex flex-col gap-2 '>
            ...
            <div className='flex gap-3 items-center cursor-pointer hover:text-zinc-300'>
              <FaLocationDot/>
              <p>Bahria Town phase 6 near HBL Bank </p>
            </div>
            <div className='flex gap-3 items-center cursor-pointer hover:text-zinc-300'>
              <IoMdMail/>
              <p className='break-words w-full'>anasusman277@gmail.com</p>
            </div>
          </div>
        </div>
        <div>
      ...
      <div className='flex justify-center pt-10'>
        <p className='px-5  border-t text-[10px] text-center'>© 2024 Anas Usman. All Rights Reserved.</p>
      </div>
    </div>
  )
}
